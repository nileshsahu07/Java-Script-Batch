...
let text2 = text1.split() //it converts string to array
...
//declaration function => output-11
// sum(5,6)
// function sum(a,b){
//     console.log(a+b)
// }
...
// expression function=> output 1st me - undefined 2nd me - TypeError - sum is not a function 3rd me - refrence error - b is not difined before initialization 4th me - refrence error - b is not difined before initialization 5th or 6th me bhi 3rd 4th ki tarah hi hoga. //arrow me bhi same hi hoga
...
//sabhi ko alag alag execute karna hai
...
// obj=> 
// how to merge two objects and an additonal value should be add also using spread oprator?
...
// const secondObj = {
//     lastName : "Pancholi",
//     Section:"B"  // if we give same key in both object and merge them then second obj value replace first obj value.
// }

// const result = {...firstObj,...secondObj,age:"18"}

// console.log(result)


//interview question => iterate an array with for in 18 above values .

// const arr = [1,5,10,23,20,18,19,15]
// for(let x in arr){
//     while(arr[x]<=23){
//         if(arr[x]>=18){
...
const arr = [2,5,7,9,5,18,19,20,21]
